...
class Book: AnonymousBook {
    ...
    init(title: String, authors: [String]) {
        ...
        // Una vez limpias tu propio desorden, llamas a super
...
extension Book {
    convenience init(title: String, author: String) {
        ...
        // Los inits de convenienciaa siempre tienen que llamar al designado
...
// Como las structs, las clases tambien implementan protocols
...
// Pueden ser de un tipo y en ese caso tiene rawValue
